...
public class SearchClientImpl implements SearchClient {
    ...
    public <T extends Document> OperationResult saveOrUpdate(String indexName, T document) {
        IndexRequest request = new IndexRequest(indexName).id(document.docId()).source(ObjectMapperUtil.asMap(document));
        try {
    ...
    @Override
    public <T extends Document> OperationResult saveOrUpdate(String indexName, Collection<T> documents) {
        return null;
    }
