...
class ObjectMapperUtilTest {
  ...
  void toJson() {
    ...
    TestRecord record =
        new TestRecord(id, localDate, localTime, localDateTime, zonedDateTime, date, colors);
    String EXPECTED_JSON =
        "{\"id\":\"12345-67890\",\"localDate\":[2020,4,1],\"localTime\":[13,12,31],\"localDateTime\":[2020,4,1,13,12,31],\"zonedDateTime\":1585761151.000000000,\"date\":1585761151000,\"colors\":[\"blue\",\"red\",\"yellow\"]}";
  ...
  void jsonToObject() {
    ...
    assertAll(
        ...
        () ->
            assertTrue(
                zonedDateTime.isEqual(result.zonedDateTime()), "ZonedDateTime did not match"),
