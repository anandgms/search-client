...
public class SearchResponseBuilder {
    ...
    private static @NonNull RangeFacetResult getDateRangeFacetResult(Map.Entry<String, Aggregate> entry) {
    ...
    private static @NonNull RangeFacetResult getNumericRangeFacetResult(Map.Entry<String, Aggregate> entry) {
    ...
    private static @NonNull HistogramFacetResult getHistogramFacetResult(Map.Entry<String, Aggregate> entry) {
